...
const Blog = () => {
    ...
    return (
        <div>
            ...
            <div className='m-8'>
                <h1>What are the different ways to manage a state in a React App?</h1>
            ...
            <div className="m-8"><h1>How does prototypical inheritance work?</h1>
                <p></p>
            </div>
            <div className="m-8">
            ...
            <div className="m-8">
                ...
                <p>I can use filter function to implement a search to find products by name. For example, if an array has products that has same name, using array.filter() function will return all the products that had same name. Example:
